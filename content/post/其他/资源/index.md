...
1. [cpp insight： 将 C++ 代码转换为内部实现形式](https://cppinsights.io/)    
2. [RGB颜色表](https://www.codeeeee.com/color/rgb.html)  
3. [Winsows开发文档](https://learn.microsoft.com/zh-cn/)   
4. [Hello-GitHub](https://hellogithub.com/)    
5. [Open-GitHub](open.itc.cn/)   
